...
def process_csv(csv_path, iou_thres=0.5):
    ...
    # Tìm max_confidence và class dự đoán tốt nhất cho mỗi anchor đã bị loại bỏ
    # Bây giờ chúng ta sử dụng cột vector_magnitude có sẵn từ file top200
    ...
    while remaining_indices:
        # Trong số các hộp còn lại, tìm hộp có vector_magnitude cao nhất
...
def main():
    ...
    for csv_path in csv_files:
        ...
        cols_to_save = ['group_id', 'vector_magnitude', 'estimated_angle', 'x_center', 'y_center', 'width', 'height'] + class_cols_to_save
