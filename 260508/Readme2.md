...
> Mỗi ảnh chụp sa bàn đều chứa 9 Leanbot. Do đó, sau khi chạy auto_label, số lượng Bounding Box (Nhãn) thu được là: `Số lượng ảnh × 9`.
...
- **Đánh giá:** Mô hình không gặp tình trạng nhầm lẫn đặc trưng chéo (ví dụ: không nhận diện sai giữa Front với Back, hay Left với Right). Điều này cho thấy thuật toán đã phân tách được các điểm neo (anchor features) của từng mặt robot ở các góc nghiêng nhỏ từ 0 đến +30 độ và -30 độ. 
