...
class OnlinePolySmoother:
    ...
    def __init__(self, window_size=SMOOTH_LENGTH, poly_degree=SMOOTH_ORDER):
        ...
        self.raw_angles = []                # To?n b? chu?i raw_angle (t? model)
        self.raw_angle_window = []          # C?a s? tr??t 30 gi? tr? raw_angle
        self.raw_angle_smooth_list = []     # To?n b? chu?i raw_angle_smooth
        self.smooth_angle_window = []       # C?a s? tr??t 30 gi? tr? smooth_angle
        self.smooth_angle_smooth_list = []  # To?n b? chu?i smooth_angle_smooth

    def _poly_smooth_scalar(self, window, value):
        """Smooth gi? tr? scalar t?i ?i?m cu?i c?a s? polynomial."""
        window.append(value)
