...
- Tài liệu tham khảo : [https://docs.opencv.org/4.x/d0/d86/tutorial_py_image_arithmetics.html](https://docs.opencv.org/4.x/d0/d86/tutorial_py_image_arithmetics.html) - Phần **Bitwise Opearation**.
