"""
plot_zoom_segments.py
─────────────────────
Chọn ngẫu nhiên các đoạn ngắn (mặc định 150 điểm ≈ 10 giây × 15 FPS) từ dữ liệu
quỹ đạo CSV, rồi vẽ chồng quỹ đạo gốc (raw) và quỹ đạo sau khi làm mượt bằng
Bidirectional EMA với nhiều giá trị alpha lên cùng một đồ thị để so sánh trực quan.

Ví dụ chạy:
    python tools/plot_zoom_segments.py benchmark
    python tools/plot_zoom_segments.py benchmark --n-segments 5 --alphas 0.1,0.2,0.3,0.5 --seed 123
"""
