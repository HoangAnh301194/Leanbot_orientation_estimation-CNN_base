...
def create_output_session_dir(session_name: str):
    ...
    paths = {
        ...
        "diff_dir": session_dir / "debug_diff_masks",
        "bbox_dir": session_dir / "debug_bbox",
    }
...
def save_detection_outputs(output_paths: dict[str, Path], base_name: str, aligned_img, diff_mask, bboxes, class_id=0):
    ...
    diff_path = output_paths["diff_dir"] / f"{base_name}.png"
    bbox_path = output_paths["bbox_dir"] / f"{base_name}.jpg"
