"""Two-phase P-only position controller for Leanbot navigation to a fixed target pixel."""
...
class PositionPIDController:
    """Kept original class name for compatibility; current algorithm uses P-only control."""
    ...
    def __init__(
        ...
        heading_tolerance_deg: float = DEFAULT_HEADING_TOLERANCE_DEG,  # 10.0 -> 5.0
    ):
